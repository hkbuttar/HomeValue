...
Step 40 provides one reusable inference interface over the fitted analytical
...
The engine is intentionally framework-independent; Step 41 exposes it through
